...
def publishMQTT(data, name, clientMQTT):
    ...
    if(name == 'FF-160'): #change ID to to the FlyTag you want
        ...
        total_absolute_acc = abs(a1x) + abs(a1y) + abs(a1z);
        if(total_absolute_acc > 2.5):
...
client = mqtt.Client("d:org-id:raspberrypi:BlueberryPie")
